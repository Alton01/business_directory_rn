...
export default function BusinessListCard({ business }) {
  ...
  return (
    <TouchableOpacity style={{ padding: 10, margin: 10, borderRadius: 15, backgroundColor: '#fff', display: 'flex', flexDirection: 'row', gap: 10, }}
    ...
    >
     ...
     <View style={{ flex: 1, gap: 3}}>
        ...
        <Text style={{ fontFamily: 'outfit', color: Colors.GRAY, fontSize: 15 }} >{business.contact}</Text>
